...
namespace AgOpenGPS
{
    public class CYouTurn
    {
        ...
        //ajout_max
        public bool Alternate_skips = Properties.Vehicle.Default.set_youAlternate_skips;
        public int Skips_1 = 1;
        public int Skips_2 = 1;
        ...
        public CYouTurn(FormGPS _f)
        {
            ...
            //ajout max 
            if (Alternate_skips == false)
            {
                rowSkipsWidth = Properties.Vehicle.Default.set_youSkipWidth;
            }

            Skips_1 = Properties.Vehicle.Default.set_youSkips_1;
            Skips_2 = Properties.Vehicle.Default.set_youSkips_2;
        ...
        public void YouTurnTrigger()
        {
            ...
            if (mf.yt.Alternate_skips == true)
            {
                if (Previous_skip == 1)
                {
                    rowSkipsWidth = mf.yt.Skips_1;
                    Previous_skip = 0;
                }
                else
                {
                    rowSkipsWidth = mf.yt.Skips_2;
                    Previous_skip = 1;
                }
