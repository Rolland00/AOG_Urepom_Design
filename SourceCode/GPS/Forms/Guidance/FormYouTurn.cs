...
namespace AgOpenGPS
{
    public partial class FormYouTurn : Form
    {
        ...
        private void FormYouTurn_Load(object sender, EventArgs e)
        {
            ...
            cboxRowWidth.SelectedIndex = Properties.Vehicle.Default.set_youSkipWidth - 1;

            //ajout max
            cboxskips_1.SelectedIndex = mf.yt.Skips_1 - 1;
            cboxskips_2.SelectedIndex = mf.yt.Skips_2 - 1;
            //fin
            ...
            //ajout max
            Alternate_skips.Checked = mf.yt.Alternate_skips;
            //fin
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            //ajout max
            Properties.Vehicle.Default.set_youAlternate_skips = mf.yt.Alternate_skips;
            if (mf.yt.Alternate_skips == true)
            {
                mf.yt.rowSkipsWidth = mf.yt.Skips_2;
            }
            mf.Alternate_skip_On();
            Properties.Vehicle.Default.set_youSkips_1 = mf.yt.Skips_1;
            Properties.Vehicle.Default.set_youSkips_2 = mf.yt.Skips_2;
            //fin
        ...
        //ajout max
        private void cboxskips_1_SelectedIndexChanged(object sender, EventArgs e)
        {
            mf.yt.Skips_1 = cboxskips_1.SelectedIndex + 1;
        }

        private void cboxskips_2_SelectedIndexChanged(object sender, EventArgs e)
        {
            mf.yt.Skips_2 = cboxskips_2.SelectedIndex + 1;
        }

        private void Alternate_skips_CheckedChanged(object sender, EventArgs e)
        {
            mf.yt.Alternate_skips = Alternate_skips.Checked;
        }
        //fin
    }
}
