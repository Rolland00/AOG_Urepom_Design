...
namespace AgOpenGPS
{
    public partial class FormHeadland : Form
    {
        ...
        public FormHeadland(Form callingForm)
        {
            ...
            label1.Text = gStr.gsUniform_headland_width;
            label2.Text = gStr.gsCustom_headland_width;
            label3.Text = gStr.gsHeadland_Text;
        ...
        private void FormHeadland_Load(object sender, EventArgs e)
        {
            ...
            //Builds line
            nudDistance.Value = (decimal)(Math.Round(mf.tool.toolWidth * 4));
