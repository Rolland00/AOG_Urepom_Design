...
namespace AgOpenGPS
{
    public partial class FormDisplayOptions : Form
    {
        ...
        public FormDisplayOptions(Form callingForm)
        {
            ...
            //ajout max
            SectionButton.Text = gStr.gsSectionbuttons;
            Uturn_without_Autosteer.Text = gStr.gsUturn_without_Autosteer;
            //fin
        }
        private void FormDisplaySettings_Load(object sender, EventArgs e)
        {
            ...
            //ajout max
            SectionButton.Checked = mf.isSectionButtons;
            Uturn_without_Autosteer.Checked = mf.isUturn_without_Autosteer;
